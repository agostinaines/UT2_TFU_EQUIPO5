...
app.configdb['JSON_AS_ASCII'] = False
app.configdb['JSONIFY_PRETTYPRINT_REGULAR'] = True
app.configdb['JSONIFY_MIMETYPE'] = "application/json; charset=utf-8"
...
app.configdb.from_object(configdb['development'])
